...
export const fetchCustomDashboardsConfig=(customDashboard)=>{
    return{
        type:"FETCH_CUSTOM_DASHBOARDS_CONFIG",
        payload:customDashboard
    }
}

export const fetchCustomDashboardsConfigFailure=(error)=>{
    return{
        type:"FETCH_CUSTOM_DASHBOARDS_ERROR",
        payload:error
    }
}
...
export const fetchEvents=(events)=>{
    return{
        type:"FETCH_DHIS2_EVENTS_CONFIG",
        payload:events
    }
}
