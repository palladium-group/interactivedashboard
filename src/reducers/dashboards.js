...
export const customDashboards=(state=initialState, action)=>{
    switch (action.type) {
        case "FETCH_CUSTOM_DASHBOARDS_CONFIG" :
            return{
                ...action.payload,
                error: ''
            }
        case "FETCH_CUSTOM_DASHBOARDS_ERROR":
            return{
...
export const eventsConfig=(state=events, action)=>{
    switch (action.type) {
        case "FETCH_DHIS2_EVENTS_CONFIG" :
            return{
                ...action.payload,
                error: ''
            }
        case "FETCH_DHIS2_EVENTS_ERROR":
            return{
                error:action.payload,
                events: []
            }
...
export const sGetCustomDashboards = state => state.customDashboards;
export const sGetEvents = state => state.eventsConfig;
...
export const sGetAllCustomDashboards = state =>
    orObject(sGetCustomDashboards(state));


export const sGetAllEvents = state =>
    orObject(sGetEvents(state));
