...
export class Item extends Component {
            ...
            case CHART: {
                ...
                return (
                    <ChartPlugin
                        ...
                        forDashboard={true}
                        style={props.style}
                        visualSwitch={this.state.visualSwitch}
                    />
                );
            }
            case MAP: {
    ...
    onSelectVisualization = (activeType, switchType = null) => {
        // Cancel request if type is already active
        /*        if (activeType === this.getActiveType()) {
                    return;
                }*/

        if (visualSwitch === switchType && activeType === this.getActiveType()) {
            return;
        }
        visualSwitch = switchType;
        this.setState({
            visualSwitch: switchType,
        });
...
const mapStateToProps = (state, ownProps) => ({
    ...
    itemFilters: sGetEditItemFiltersRoot(state),
