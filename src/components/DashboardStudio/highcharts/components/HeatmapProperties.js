...
function HeatmapProperties(props) {
    ...
    useEffect(()=>{
        if(columns.columns.items.length>0){
            let category=columns.columns.items[0]
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={6} sm={6} md={6} lg={6} >
                                <Grid item xs={12} sm={12} md={12} lg={12} >
                                    <h2 className={classes.heading}>Row Dimension</h2>
                                    <div style={{ margin: 8 }}>
                                        <Droppable droppableId='rows' key='rows'>
                                            {(provided, snapshot) => {
                                                return (
                                                    <div
                                                        {...provided.droppableProps}
                                                    ...
                                                    >
                                                        {columns.rows.items.map((item, index) => {
                                                            return (
                                                                <Draggable
                                                                    key={item.id}
                                                                    draggableId={item.id}
                                ...
                                <Grid item xs={12} sm={12} md={12} lg={12} >
                                    <h2 className={classes.heading}>Column Dimension</h2>
                                    <div style={{ margin: 8 }}>
                                ...
                                <Grid item xs={12} sm={12} md={12} lg={12} >
                                    <h2 className={classes.heading}>Value Dimension</h2>
                                    <div style={{ margin: 8 }}>
                                        <Droppable droppableId='values' key='values'>
                                            {(provided, snapshot) => {
                                                return (
                                                    <div
                                                        {...provided.droppableProps}
                                                    ...
                                                    >
                                                        {columns.values.items.map((item, index) => {
                                                            return (
                                                                <Draggable
                                                                    key={item.id}
                                                                    draggableId={item.id}
