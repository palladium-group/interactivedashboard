...
import configureStore, {fetchCustomDashboards, fetchEventsConfig} from './configureStore';
...
const init = async () => {
    await configureStore().dispatch(fetchCustomDashboards())
    ...
    const authorization = manifest.users[lang].auth;
    console.log("language auth",authorization)
